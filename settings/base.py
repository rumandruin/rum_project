# flake8: noqa
"""
Django settings for rum_project project.
...
DJANGO_ROOT = root.path('rum_project')
...
WSGI_APPLICATION = 'rum_project.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///rum_project'),
}
